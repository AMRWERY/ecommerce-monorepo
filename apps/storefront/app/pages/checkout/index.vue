<template>
  <div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <!-- Page Title -->
      <h1 class="text-3xl sm:text-4xl lg:text-[40px] font-black uppercase tracking-tight mb-6 sm:mb-8 text-black dark:text-white">
        Checkout
      </h1>
      ...
      <form @submit.prevent="handlePlaceOrder">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div class="lg:col-span-7 space-y-6">
            ...
            <!-- 1. Contact Details -->
            <section class="border border-gray-200 dark:border-neutral-800 rounded-[20px] p-5 sm:p-6 bg-white dark:bg-[#1A1D25] space-y-4">
              <h2 class="text-lg sm:text-xl font-bold flex items-center gap-2 text-black dark:text-white">
                <span class="w-7 h-7 rounded-full bg-black dark:bg-white text-white dark:text-black text-sm flex items-center justify-center font-black shrink-0">1</span>
                Contact Details
              </h2>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2 space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Email Address <span class="text-red-500">*</span></label>
                  <div class="relative">
                    <Icon name="lucide:mail" class="absolute start-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-neutral-500" />
                    <input v-model="form.email" type="email" required placeholder="john@example.com"
                      class="input-field ps-11" />
                  </div>
                </div>
                <div class="sm:col-span-2 space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Phone Number <span class="text-red-500">*</span></label>
                  <div class="relative">
                    <Icon name="lucide:phone" class="absolute start-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-neutral-500" />
            ...
            <section class="border border-gray-200 dark:border-neutral-800 rounded-[20px] p-5 sm:p-6 bg-white dark:bg-[#1A1D25] space-y-4">
              <h2 class="text-lg sm:text-xl font-bold flex items-center gap-2 text-black dark:text-white">
                <span class="w-7 h-7 rounded-full bg-black dark:bg-white text-white dark:text-black text-sm flex items-center justify-center font-black shrink-0">2</span>
                Shipping Address
              </h2>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">First Name <span class="text-red-500">*</span></label>
                  <input v-model="form.firstName" type="text" required placeholder="John" class="input-field" />
                </div>
                <div class="space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Last Name <span class="text-red-500">*</span></label>
                  <input v-model="form.lastName" type="text" required placeholder="Doe" class="input-field" />
                </div>
                <div class="sm:col-span-2 space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Street Address <span class="text-red-500">*</span></label>
                  <div class="relative">
                    <Icon name="lucide:map-pin" class="absolute start-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-neutral-500" />
                    <input v-model="form.address" type="text" required placeholder="123 Fashion Street, Apt 4B"
                      class="input-field ps-11" />
                  </div>
                </div>
                <div class="space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">City <span class="text-red-500">*</span></label>
                  <input v-model="form.city" type="text" required placeholder="New York" class="input-field" />
                </div>
                <div class="space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Postal Code <span class="text-red-500">*</span></label>
                  <input v-model="form.postalCode" type="text" required placeholder="10001" class="input-field" />
                </div>
                <div class="sm:col-span-2 space-y-1.5">
                  <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Country <span class="text-red-500">*</span></label>
            ...
            <section class="border border-gray-200 dark:border-neutral-800 rounded-[20px] p-5 sm:p-6 bg-white dark:bg-[#1A1D25] space-y-4">
              <h2 class="text-lg sm:text-xl font-bold flex items-center gap-2 text-black dark:text-white">
                <span class="w-7 h-7 rounded-full bg-black dark:bg-white text-white dark:text-black text-sm flex items-center justify-center font-black shrink-0">3</span>
                Delivery Method
              </h2>
                ...
                >
                  ...
                  <div class="flex items-center justify-between gap-2">
                    ...
                    <div class="flex items-center gap-1.5 shrink-0">
                      ...
                      <span
                        v-if="form.deliveryMethod === option.id"
            ...
            <section class="border border-gray-200 dark:border-neutral-800 rounded-[20px] p-5 sm:p-6 bg-white dark:bg-[#1A1D25] space-y-4">
              <h2 class="text-lg sm:text-xl font-bold flex items-center gap-2 text-black dark:text-white">
                <span class="w-7 h-7 rounded-full bg-black dark:bg-white text-white dark:text-black text-sm flex items-center justify-center font-black shrink-0">4</span>
                Payment Method
              </h2>
              ...
              <Transition enter-active-class="transition-all duration-300 ease-out" enter-from-class="opacity-0 -translate-y-2" enter-to-class="opacity-100 translate-y-0">
                <div v-if="form.paymentMethod === 'card'" class="space-y-4 pt-2">
                  <div class="space-y-1.5">
                    <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Cardholder Name <span class="text-red-500">*</span></label>
                    <input v-model="form.cardHolder" type="text" :required="form.paymentMethod === 'card'" placeholder="John Doe" class="input-field" />
                  </div>
                  <div class="space-y-1.5">
                    <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Card Number <span class="text-red-500">*</span></label>
                    <div class="relative">
                      <Icon name="lucide:credit-card" class="absolute start-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-neutral-500" />
                      <input v-model="form.cardNumber" type="text" :required="form.paymentMethod === 'card'"
                        placeholder="0000 0000 0000 0000" maxlength="19"
                        @input="formatCardNumber"
                        class="input-field ps-11 font-mono tracking-widest" />
                    </div>
                  </div>
                  <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                      <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">Expiry Date <span class="text-red-500">*</span></label>
                    ...
                    <div class="space-y-1.5">
                      <label class="block text-xs font-semibold text-neutral-600 dark:text-neutral-300">CVV <span class="text-red-500">*</span></label>
                      <div class="relative">
                        <input v-model="form.cvv" type="password" :required="form.paymentMethod === 'card'"
                          placeholder="•••" maxlength="4" class="input-field font-mono" />
                        <Icon name="lucide:lock" class="absolute end-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300 dark:text-neutral-600" />
                      </div>
                    </div>
                  </div>
              ...
              <Transition enter-active-class="transition-all duration-300 ease-out" enter-from-class="opacity-0 -translate-y-2" enter-to-class="opacity-100 translate-y-0">
                <div v-if="form.paymentMethod === 'cod'" class="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 rounded-[12px] p-4 flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-amber-700 dark:text-amber-400 mt-0.5">Pay in cash when your order arrives. Additional fees may apply depending on location.</p>
                  </div>
                </div>
              </Transition>
              ...
              <!-- Apple Pay Note -->
              <Transition enter-active-class="transition-all duration-300 ease-out" enter-from-class="opacity-0 -translate-y-2" enter-to-class="opacity-100 translate-y-0">
                <div v-if="form.paymentMethod === 'apple_pay'" class="bg-gray-50 dark:bg-neutral-800/50 border border-gray-200 dark:border-neutral-700 rounded-[12px] p-4 flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-neutral-400 mt-0.5">Complete payment securely using Apple Pay on your device.</p>
                  </div>
                </div>
              </Transition>
            </section>
          ...
          <div class="lg:col-span-5 space-y-4 lg:sticky lg:top-6">
            <div class="border border-gray-200 dark:border-neutral-800 rounded-[20px] p-5 sm:p-6 bg-white dark:bg-[#1A1D25] space-y-5">
              ...
              <div class="space-y-3 divide-y divide-gray-100 dark:divide-neutral-800">
                <div v-for="item in cartStore.items" :key="item.id"
                  ...
                  <div class="w-14 h-14 rounded-[10px] bg-[#F0EEED] dark:bg-neutral-800 overflow-hidden flex items-center justify-center shrink-0">
              ...
              <p class="text-center text-xs text-gray-400 dark:text-neutral-500 flex items-center justify-center gap-1.5">
