<template>
  <div class="min-h-[calc(100vh-16rem)] flex items-center justify-center py-10 sm:py-16 px-4">
    <div class="w-full max-w-md space-y-8 bg-white dark:bg-[#1A1D25] p-6 sm:p-10 rounded-3xl border border-gray-200/80 dark:border-neutral-800 shadow-xl transition-colors">
      <!-- Header -->
      <div class="text-center space-y-2">
        <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-black text-white dark:bg-white dark:text-black mb-2 shadow-md">
      ...
      <div class="relative flex items-center justify-center">
        ...
        <span class="bg-white dark:bg-[#1A1D25] px-3 text-xs uppercase tracking-wider text-gray-400 font-medium shrink-0">
          Or continue with
        </span>
      </div>
