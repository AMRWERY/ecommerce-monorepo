<template>
    <section
        class="w-full bg-white dark:bg-[#0E1015] py-4 sm:py-7 border-b border-gray-100 dark:border-neutral-800 transition-colors">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Section Title -->
            <h2
                class="text-3xl sm:text-4xl lg:text-5xl font-black text-center text-black dark:text-white uppercase tracking-tight mb-10 sm:mb-14">
                Top Selling
            </h2>
